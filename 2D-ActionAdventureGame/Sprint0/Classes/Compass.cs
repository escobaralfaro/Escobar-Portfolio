...
namespace Sprint0.Classes
{
    internal class Compass : Iitem
    {
        ...
        public ItemType CurrentItemType => ItemType.compass;
        ...
        public Compass(Vector2 position, Link link, Link link2)
        {
        ...
        public void LoadContent(ContentManager content, string texturePath, GraphicsDevice graphicsdevice, ItemType itemType, Vector2 scale)
        {
            ...
            SourceRectangles = SpriteSheetHelper.CreateCompassItemFrames();
