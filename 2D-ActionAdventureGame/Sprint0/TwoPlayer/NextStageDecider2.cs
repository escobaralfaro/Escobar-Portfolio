...
{
    public class NextStageDecider2
    {
        private Link _link;
        private Link _link2;
        ...
        private StageManager2 _stageManager;
        ...
        public NextStageDecider2(Link link, Link link2, Vector2 scale, DoorMap doorMap, StageManager2 stageManager)
        {
            _link = link;
            _link2 = link2;
            _scale = scale;
            ...
            Door2 = GetDoorRectangle(16, 127, 32, 32, _scale);
        ...
        public int DecideStage()
        {
            ...
            if(playerBoundingBox.Intersects(Door1) || playerBoundingBox2.Intersects(Door1))
            {
                ...
                else if (doors[0] == 1 || doors[0] == 4)
                {
                    ...
                    _link2._position.X = 128 * _scale.X;
                    _link2._position.Y = 180 * _scale.Y;
                    _link.transitioning = true;
                    _link2.transitioning = true;
                    switch (_stage)
                    {
                        case 0: 
            ...
            } else if (playerBoundingBox.Intersects(Door4) || playerBoundingBox2.Intersects(Door4))
            {
                ...
                } else if (doors[3] == 1 || doors[3] == 4)
                {
                    ...
                    _link2._position.X = 120 * _scale.X;
                    _link2._position.Y = 87 * _scale.Y;
                    _link.transitioning = true;
                    _link2.transitioning = true;
                    switch (_stage)
                    {
            ...
            } else if (playerBoundingBox.Intersects(Door2) || playerBoundingBox2.Intersects(Door2)) 
            {
                ...
                else if (doors[1] == 1 || doors[1] == 4)
                {
                    ...
                    _link2._position.X = 210 * _scale.X;
                    _link2._position.Y = 135 * _scale.Y;
                    _link.transitioning = true;
                    _link2.transitioning = true;
                    switch (_stage)
                    {
            ...
            } else if (playerBoundingBox.Intersects(Door3) || playerBoundingBox2.Intersects(Door3))
            {
                if (canUnlockDoor && doors[2] == 2)
                {
                ...
                else if (doors[2] == 1 || doors[2] == 4)
                    {
                        ...
                        _link._position.Y = 135 * _scale.Y;
                        _link2._position.X = 32 * _scale.X;
                        _link2._position.Y = 135 * _scale.Y;
                        _link.transitioning = true;
                        _link2.transitioning = true;
                        switch (_stage)
